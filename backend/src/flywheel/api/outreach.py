...
# ---------------------------------------------------------------------------
# Pipeline view (REMOVED — replaced by unified pipeline router in pipeline.py)
# Old get_pipeline and get_pipeline_industries removed: they queried the
# accounts/outreach_activities tables which were renamed to *_legacy in Phase 84.
# ---------------------------------------------------------------------------
