...
> overlap, GTM version adds parallel multi-term scraping, smarter dedup, safer file handling).
> Use the GTM version for all new scraping tasks.
...
**Memory file:** `~/.claude/projects/-Users-sharan/memory/web-scraper-extractor.md`
