...
- [66.1-01 execution]: AliasChoices on supabase_service_key accepts SUPABASE_SERVICE_KEY, SUPABASE_SERVICE_ROLE_KEY, and supabase_service_key -- backward compatible with any env var naming
- [66.1-01 execution]: Local imports of settings in meeting_processor_web.py and relationships.py to avoid circular import risk
- [66.1-01 execution]: Migration 034 tasks table has no FK on user_id -- profiles managed by Supabase Auth (matches meetings table pattern from 032)
